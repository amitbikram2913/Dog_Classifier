# -*- coding: utf-8 -*-
"""
Created on Thu Jun 21 18:53:41 2018
...
#    imag[i] = cv2.cvtColor(images[i], cv2.COLOR_BGR2RGB)
...
def augment_data(images):
    ...
    def rot_shift(imag):
        ...
        N = cv2.getRotationMatrix2D((cols/2,rows/2),randint(-45,45),1)
    ...
    def shear_shift(imag):
        ...
        S = np.float32([[1,0,0],[randint(-0.2,0.2),1,0]])
    ...
    my_list = [clr_chng, trans_shift, rot_shift, shear_shift, smooth_pic, hor_flip, ver_flip]
    for imag in images:
        imag = random.choice(my_list)(imag)
    ...
    [
        ...
        iaa.SomeOf((0, 5),
            [
                ...
                iaa.Sharpen(alpha=(0, 1.0), lightness=(0.75, 1.0)),
